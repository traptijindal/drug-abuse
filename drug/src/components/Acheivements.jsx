...
function Achievements() {
  return (
    <div className='mx-5 md:mx-20 my-5 md:my-10 p-4 md:p-7 text-white rounded-xl' style={{ backgroundColor: '#228B22' }}>
      <h1 className='text-2xl md:text-3xl mb-4 md:mb-7 font-bold'>Our Achievements</h1>
