...
function Mental() {
  return (
    ...
    <div style={{ textAlign: "center", padding: "20px" }}>
      <h1 style={{ fontSize: "3rem", fontWeight: "bold" }}>MENTAL ILLNESS</h1>

      <div className='flex my-8 justify-center items-center'>
        <img className='w-1/4 m-8' src="\images\c_1.jpg" alt="" />
      ...
      <h3 className='text-3xl leading-loose font-semibold uppercase underline'>Causes</h3>
      <div className='my-8 flex flex-row-reverse justify-center text-center'>
        <img className='w-1/4  m-8' src="\images\c_6.jpg" alt="" />
        <div>
          <span className='text-s leading-loose'>
            1. Mental illnesses often result from a combination of genetic, biological, environmental, and psychological factors.
            Trauma, stress, and a family history of mental health disorders can contribute to the development of mental illnesses.<br />

            2. Symptoms: Symptoms vary depending on the specific mental health disorder but may include changes in mood, behavior, cognition, and social interactions.
            Physical symptoms such as changes in sleep patterns, appetite, and energy levels may also be present.<br />

            3. Treatment: Treatment options include psychotherapy (counseling or talk therapy), medication, support groups, and lifestyle changes.
            In severe cases, hospitalization may be necessary for stabilization and safety.<br />

            4. Stigma and Awareness: Stigma surrounding mental illness can contribute to discrimination and reluctance to seek help.
            Increased awareness and education are essential to combat stigma and promote understanding of mental health issues.<br />
          </span>
        </div>
      </div>

      <h3 className='text-3xl leading-loose font-semibold uppercase underline'>Consequences</h3>
      <div className='my-8 flex justify-center items-center'>
        <img className='w-1/3 h-50 m-8 ' src="\images\drug3.jpg" alt="" />
        <div>
          <span className=' leading-loose text-s'>
      ...
      <div className='my-8 flex flex-row-reverse justify-center items-center'>
        <img className='w-1/3 h-3/4 m-8' src="\images\mental2.avif" alt="" />
        <div>
          <span className='text-s leading-loose'>
